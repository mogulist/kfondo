...
const formSchema = z.object({
  ...
  color_from: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Must be a valid hex color code"),
  color_to: z.string().regex(/^#[0-9A-Fa-f]{6}$/, "Must be a valid hex color code"),
...
export function EventForm({ initialData }: EventFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-2xl bg-white dark:bg-slate-950 p-6 rounded-lg border">
        ...
        <div className="grid grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Theme Color (From)</FormLabel>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Theme Color (To)</FormLabel>
                <div className="flex gap-2 items-center">
                   <FormControl>
                    <Input type="color" className="w-12 h-10 p-1" {...field} />
                  </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea placeholder="Join us for the ultimate riding experience..." {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
